...
public class AspectLogger {
	...
	@AfterThrowing(pointcut = "execution(* com.mindtree.order.management.ordermanagementservice.*.*.*(..))", throwing = "exception")
	...
	@AfterReturning(pointcut = "execution(* com.mindtree.order.management.ordermanagementservice.*.*.*(..))", returning = "result")
