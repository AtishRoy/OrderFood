...
public class Restaurant implements Serializable {
	...
	/*
	 * @ApiModelProperty(notes = "Latitude location of the restaurant") private String lat_location;
	 * 
	 * @ApiModelProperty(notes = "Longitude location of the restaurant") private String lon_location;
	 */
	@Field(type = FieldType.Nested, includeInParent = true)
