...
public class CustomerRepositoryTest {
    ...
    public void setup() {
        ...
        Customer customer = new Customer(2L, "firstname", "lastName", "user@example.com", "12432435", new Date(),
            new Address(2L, "address", "landmark", "area", "city", "state", "+12.3456", "-12.3456", "123456"), "ACTIVE",
            new Date());
        entityManager.merge(customer);
        entityManager.flush();
        Customer customer1 = new Customer(3L, "firstname", "lastName", "user1@example.com", "124324351", new Date(),
            new Address(3L, "address", "landmark", "area", "city", "state", "+12.3456", "-12.3456", "123456"), "INACTIVE",
            new Date());
