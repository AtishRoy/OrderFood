...
public class MapperTest {
    ...
    public void testBuildCustomerForUpdateCustomerPhone() {
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "0243243556", "22-10-1989", "address", "land",
            "area", "city", "state", "latitude", "longitude", "pinCode", "user");
        CustomerMapper.buildCustomerForUpdateCustomer("Sucess", customerReq);
    }
    @Test(expected=InvalidDataFormatException.class)
    public void testBuildCustomerForUpdateCustomerPin() {
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "243243556", "22-10-1989", "address", "land",
            "area", "city", "state", "latitude", "longitude", "023432", "user");
        CustomerMapper.buildCustomerForUpdateCustomer("Sucess", customerReq);
    }
    @Test(expected=InvalidDataFormatException.class)
    public void testBuildCustomerForUpdateCustomer1() {
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "124", "22-10-1989", "address", null,
            "area", "city", "state", "latitude", "longitude", "pinCode", "user");
        CustomerMapper.buildCustomerForUpdateCustomer("Sucess", customerReq);
    }
    @Test(expected=InvalidDataFormatException.class)
    public void testBuildCustomerForUpdateCustomer2() {
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "12432dfgrdr", "22-10-1989", "address", "",
            "area", "city", "state", "latitude", "longitude", "pinCode", "user");
        CustomerMapper.buildCustomerForUpdateCustomer("Sucess", customerReq);
    }
    @Test
    ...
    public void testBuildCustomerForNewCustomerPhone() {
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "12432556", "22-10-1989", "address", "land",
            "area", "city", "state", "latitude", "longitude", "pinCode", "user");
    ...
    public void testmapDobblank4() {
        ...
        CustomerRequest customerReq = new CustomerRequest("sds", "sdfds", "1243243556", "22-08-1989", "address", "land",
            "area", "city", "state", "latitude", "longitude", "pinCode", "user");
