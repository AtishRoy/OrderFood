...
public class AspectLogger {
	...
	@AfterThrowing(value = "execution(* com.mindtree.customer.management.*.*.*(..))", throwing = "throwable")
	...
	@AfterReturning(value = "execution(* com.mindtree.customer.management.*.*.*(..))", returning = "result")
